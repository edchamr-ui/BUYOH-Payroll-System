"""United Kingdom Statutory Adoption Pay for the 2026/27 rate year."""
...
ZERO = Decimal("0.00")
PENNY = Decimal("0.01")
SAP_STANDARD_WEEKLY_RATE_2026_27 = Decimal("194.32")
SAP_EARNINGS_PERCENTAGE = Decimal("0.90")
SAP_LOWER_EARNINGS_LIMIT_2026_27 = Decimal("129.00")
SAP_HIGHER_RATE_WEEKS = 6
SAP_MAX_WEEKS = 39
SAP_RATE_YEAR_START_2026_27 = date(2026, 4, 5)
SAP_RATE_YEAR_END_2026_27 = date(2027, 4, 4)
...
class StatutoryAdoptionPayResult:
    """Auditable SAP result for one payroll-period allocation."""
...
def calculate_sap_2026_27(
    *,
    ...
    """Calculate SAP payable under the rate applying from 5 April 2026.

    SAP is a weekly benefit apportioned by calendar day. ``paid_days`` is the
    number of SAP calendar days falling in this payroll calculation, while
    ...
    employment continuity, and determining the adoption pay period.
    """
    ...
    if payment_date is not None:
        ...
        if not SAP_RATE_YEAR_START_2026_27 <= payment_date <= SAP_RATE_YEAR_END_2026_27:
            raise ValueError(
                "The 2026/27 SAP routine only supports payment dates from "
                "5 April 2026 through 4 April 2027."
            )

    eligible = awe >= SAP_LOWER_EARNINGS_LIMIT_2026_27
    higher_weekly_unrounded = awe * SAP_EARNINGS_PERCENTAGE
    standard_weekly_unrounded = min(
        SAP_STANDARD_WEEKLY_RATE_2026_27,
        higher_weekly_unrounded,
    )

    maximum_days = SAP_MAX_WEEKS * 7
    higher_rate_limit = SAP_HIGHER_RATE_WEEKS * 7
    ...
    return StatutoryAdoptionPayResult(
        rate_year="2026/27",
        average_weekly_earnings=_money(awe),
        lower_earnings_limit=SAP_LOWER_EARNINGS_LIMIT_2026_27,
        ...
        standard_rate_cap_applied=(
            higher_weekly_unrounded > SAP_STANDARD_WEEKLY_RATE_2026_27
        ),
    )
